...
Updates:
- worldbible_refined_bundle_20260303/population/P-*.yaml (derived block)
- worldbible_refined_bundle_20260303/population/population_slots.csv (DT/NFC/SM columns)
"""
...
def parse_args() -> argparse.Namespace:
    ...
    default_population_dir = repo_root / "worldbible_refined_bundle_20260303" / "population"
    default_csv = default_population_dir / "population_slots.csv"
    default_failed = repo_root / "world_ops" / "batch" / "population_derive_failed_ids.txt"
