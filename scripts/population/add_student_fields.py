...
[추가 필드]
  ...
  mana_color  : 마나 주색 (청/황/적/녹/백/자/흑)
...
[배분]
  ...
  mana_color(내부 탑분포): 청900 / 황650 / 적600 / 녹515 / 백450 / 자428 / 흑57
  major:   vocation별 분기
...
TOWER_MAJORS = {
    "청탑":  [("성벽수호학파", 520), ("결박제어학파", 350), ("좌표감리학파", 30)],
    "황탑":  [("탄도관성학파", 350), ("자계유도학파", 160), ("군진선도학파", 140)],
    "적탑":  [("열압포격학파", 380), ("용융형상학파", 165), ("연무통제학파", 55)],
    "녹탑":  [("응급약리학파", 330), ("생태계약학파", 150), ("균사환경학파", 35)],
    "백탑":  [("생명고정학파", 360), ("정화광휘학파", 75), ("서약집행학파", 15)],
    "자탑": [("교신전심학파", 300), ("허상연출학파", 127), ("보존각인학파", 1)],
    "흑탑":  [("침식주술학파", 40), ("음영잠행학파", 12), ("단절추방학파", 5)],
}
