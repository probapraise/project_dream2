...
def parse_args() -> argparse.Namespace:
    ...
    default_csv = repo_root / "worldbible_refined_bundle_20260303" / "population" / "population_slots.csv"
    default_out = repo_root / "world_ops" / "batch" / "population_derive_requests.jsonl"
