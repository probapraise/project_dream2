...
- [ ] 불가침 블록, 괄호 표기, 문장비전, 주인공 성장선이 훼손되지 않는 검증 게이트가 준비된다.
- [ ] 보존각인학파는 `학파명/핵심 위상 유지 + 전승 12식 부분 재점검 가능` 원칙으로 별도 보호/해제 규칙이 문서화된다.
...
- note:
  ...
  - 2026-03-17 추가 승인: `보존각인학파`는 학파명과 몰락/부흥 축, 핵심 위상은 유지하되 전승 12식은 남길 것과 고칠 것을 나누어 부분 재점검할 수 있다.
