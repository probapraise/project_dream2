...
최종 업데이트: 2026-03-04 (세션 3, 합의 반영 정리)
...
3. **인덱스 재생성** — `python3 scripts/rebuild_character_index_v2.py` (새 필드 + 최신 기숙사 배정 규칙 반영 확인)
...
- 반영 문서: `worldbible_refined_bundle_20260303/docs/population_grammar.md` (v0.3)
...
- 상태: 진행 중 (2026-03-04 세션 3)
  - Layer B 문서 생성 및 ATOM-001 등록 완료
  - Layer A 문서는 미생성 (후속 작업)
...
- 상세: `docs/community_grammar_layer_b.md`
...
- ~~레이어 A/B 각인광장 공간 분리 여부 결정~~ → 확정: 단일 익명 게시판에만 적용 (docs/community_grammar_layer_b.md)
...
| `scripts/add_student_fields.py` | P-* 추가 필드 배정 (grade/mana_color/major 등) |
